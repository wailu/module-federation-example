...
var moduleMap = {
	"renderAppOne": () => {
		return Promise.all([__webpack_require__.e("vendors-node_modules_react-dom_client_js"), __webpack_require__.e("src_utils_renderAppOne_ts")]).then(() => (() => ((__webpack_require__(/*! ./src/utils/renderAppOne.ts */ "./src/utils/renderAppOne.ts")))));
	},
	"g": () => {
		return __webpack_require__.e("src_utils_g_ts").then(() => (() => ((__webpack_require__(/*! ./src/utils/g.ts */ "./src/utils/g.ts")))));
	}
};
...
/******/ 	(() => {
/******/ 		var chunkMapping = {
/******/ 			"webpack_container_remote_app1_App": [
/******/ 				"webpack/container/remote/app1/App"
/******/ 			],
/******/ 			"webpack_container_remote_app2_f": [
/******/ 				"webpack/container/remote/app2/f"
/******/ 			]
/******/ 		};
...
/******/ 					} else {
/******/ 						if(!/^webpack_container_remote_app(1_App|2_f)$/.test(chunkId)) {
